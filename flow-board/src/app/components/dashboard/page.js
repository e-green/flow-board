      ...
      >
        ...
        <div className="mt-6">
          ...
          <div className="flex items-center justify-between mb-4">
            <a href="/components/task/createTask" className="hover:bg-blue-950 px-4 py-2 rounded">
              Add Page
            </a>
          ...
          <div>
        {/* <h3 className="text-xs font-bold mb-2">Tasks</h3> */}
        <ul>
          {tasks.map((task) => (
            <li key={task.id} className="block px-4 py-2 cursor-pointer text-gray-400 hover:bg-gray-200" onClick={() => handleTaskClick(task.id)}>
              {task.title}
            </li>
          ))}
        </ul>
          ...
          {/* <button className="w-full flex items-center justify-center bg-blue-800 py-2 rounded hover:bg-blue-700">
        ...
        <button
          onClick={handleLogout}
          className="w-full flex items-center justify-center bg-red-600 text-white py-2 rounded hover:bg-red-500 transition-colors mt-4"
        >
          <PowerIcon className="h-5 w-5 mr-2" />
          Logout
        </button>
